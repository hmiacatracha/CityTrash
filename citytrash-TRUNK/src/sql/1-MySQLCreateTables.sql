...
CAMION_ID INT,
CONSTRAINT RUTAS_DIARIAS_PK PRIMARY KEY(RUTA_ID,FECHA))
ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE TBL_SENSORES ADD CONSTRAINT SENSORES_CONTENEDOR_FK FOREIGN KEY(CONTENEDOR)
REFERENCES TBL_CONTENEDORES (CONTENEDOR_ID) ON UPDATE CASCADE; 
