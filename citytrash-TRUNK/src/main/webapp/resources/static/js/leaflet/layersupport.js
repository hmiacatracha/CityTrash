...
!function(e, r) {
	...
	e.MarkerClusterGroup.LayerSupport = e.MarkerClusterGroup.extend({
		...
		addLayers : function(r) {
			var o,
				...
				n = s.groups;
			for (this._originalAddLayers(s.singles), o = 0; o < n.length; o++) t = n[o], i = e.stamp(t), this._proxyLayerGroups[i] = t,
		...
		removeLayers : function(r) {
			var o,
				...
				n = a.singles,
				p = 0;
			for (this._originalRemoveLayers(n); p < s.length; p++) o = s[p], t = e.stamp(o),
				delete this._proxyLayerGroups[t]
				, this._map ? this._map._originalRemoveLayer(o) : this._proxyLayerGroupsNeedRemoving[t] = o;
			return this
		},
		...
		onAdd : function(r) {
			...
			for (o in this._proxyLayerGroupsNeedRemoving) t = this._proxyLayerGroupsNeedRemoving[o], r._originalRemoveLayer(t),
		...
		_checkInGetSeparated : function(r) {
			var o,
				t,
				i = this._separateSingleFromGroupLayers(r, {
					groups : [],
					singles : []
				}),
				a = i.groups,
		...
		_dismissProxyLayerGroup : function(o) {
			if (o._proxyMcgLayerSupportGroup !== r && o._proxyMcgLayerSupportGroup === this) {
				...
				, o.addLayer = o._originalAddLayer, o.removeLayer = o._originalRemoveLayer, o.onAdd = o._originalOnAdd, o.onRemove = o._originalOnRemove;
				var t = e.stamp(o);
				delete this._proxyLayerGroups[t]
				,
		...
		_removeFromOtherGroupsOrMap : function(e) {
			...
			if (r) {
				...
				e.__parent ? e.__parent._group.removeLayer(e) : this._removeFromOwnMap(e)
		},
	...
	var o = e.FeatureGroup.extend({
			...
			removeLayer : function(r) {
				...
				var o = e.stamp(r);
				return this._map && this._layers[o] && this._map._originalRemoveLayer(this._layers[o]),
		...
		t = {
			...
			removeLayer : function(e) {
				...
				return this._proxyMcgLayerSupportGroup.removeLayer(e),
