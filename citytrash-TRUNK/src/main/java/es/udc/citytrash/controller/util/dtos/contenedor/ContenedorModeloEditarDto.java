...
public class ContenedorModeloEditarDto {

	public ContenedorModeloEditarDto() {

	}

	public ContenedorModeloEditarDto(ContenedorModelo modelo) {
		this.id = modelo.getId();
		this.nombre = modelo.getModelo();
		this.capacidadNominal = modelo.getCapacidadNominal();
		this.cargaNominal = modelo.getCargaNominal();
		this.profundidad = modelo.getProfundidad() != null ? modelo.getProfundidad() : new BigDecimal(0);
