...
@Component
public class TrabajadorInactivompl implements ConstraintValidator<TrabajadorInactivo, Long> {

	@Autowired
	TrabajadorService tservicio;

	final Logger logger = LoggerFactory.getLogger(TrabajadorInactivompl.class);


	@Override
	public void initialize(final TrabajadorInactivo trabajador) {
